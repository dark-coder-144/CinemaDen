    ...
    return (
        ...
        <DialogContent className="bg-black text-white p-0 overflow-hidden">
            ...
            <DialogDescription className="text-center text-zinc-500">
                Invite other movie lovers out there and form a movie community!!
            </DialogDescription>
            </DialogHeader>
            <div className="p-6">
                <Label className="uppercase text-sx font-bold text-secondary/70">
                    Server Invite Link
                </Label>
                <div className="flex items-center mt-2 gap-x-2">
                    <Input disabled={isLoading} className="bg-300/70 border-0 focus-visible:ring-0 text-black focus:visible:ring-offset-0"
                    value={inviteUrl}/>
